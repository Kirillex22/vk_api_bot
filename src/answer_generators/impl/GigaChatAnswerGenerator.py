            ...
            def default_init_dialog_prompt_fabric(context: str) -> ChatPromptTemplate:
                return ChatPromptTemplate.from_messages([
                    ("system",
                     ...
                     Правила:
                     1) Ты должен в точности имитировать письменную речь, включая пунктуацию, использование заглавных букв и прочих атрибутов сообщений цели, которая помечена как 'ты'.
